    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-white/80 backdrop-blur-sm border border-[#c9ece7] rounded-xl p-6">
          ...
          <p className="text-3xl font-bold text-blue-400 mt-2">1,320</p>
        </div>
        <div className="bg-white/80 backdrop-blur-sm border border-[#c9ece7] rounded-xl p-6">
          <p className="text-gray-800 text-sm">Kondisi Baik</p>
          <p className="text-3xl font-bold text-green-400 mt-2">520</p>
        </div>
        <div className="bg-white/80 backdrop-blur-sm border border-[#c9ece7] rounded-xl p-6">
          <p className="text-gray-800 text-sm">Perlu Perbaikan</p>
          <p className="text-3xl font-bold text-red-400 mt-2">50</p>
        </div>
      </div>
        ...
        <div className="bg-white/80 backdrop-blur-sm border border-[#c9ece7] rounded-xl p-6">
          ...
          <ResponsiveContainer width="100%" height={300}>
            <LineChart data={trendData}>
              ...
              <Legend />
              <Line type="monotone" dataKey="baik" stroke="#10B981" strokeWidth={2} name="Baik" />
              <Line type="monotone" dataKey="sedang" stroke="#F59E0B" strokeWidth={2} name="Sedang" />
              <Line type="monotone" dataKey="rusak" stroke="#EF4444" strokeWidth={2} name="Rusak" />
            </LineChart>
          </ResponsiveContainer>
        </div>
      </div>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-gray-700">
                ...
                <th className="text-left py-3 px-4 text-gray-300">Jalan (km)</th>
                <th className="text-left py-3 px-4 text-gray-300">Jembatan</th>
                <th className="text-left py-3 px-4 text-gray-300">Sekolah</th>
            ...
            <tbody>
              {[
                ...
                <tr key={idx} className="border-b border-gray-700 hover:bg-gray-700 transition-colors">
                  ...
                  <td className="py-3 px-4 text-gray-300">{row.jalan}</td>
                  <td className="py-3 px-4 text-gray-300">{row.jembatan}</td>
                  <td className="py-3 px-4 text-gray-300">{row.sekolah}</td>
