      ...
      <div className="px-3 sm:px-6 py-4 sm:py-6 space-y-4 sm:space-y-6">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
          {[
            ...
            { label: "Rata-rata Skor Fasilitas", value: stats.avgFasilitas, color: "from-green-700 to-green-300" },
            { label: "Rata-rata Skor Tenaga", value: stats.avgTenaga, color: "from-teal-700 to-teal-300" },
            { label: "Rata-rata Skor Kesehatan", value: stats.avgKesehatan, color: "from-cyan-700 to-cyan-300" },
          ].map((stat, idx) => (
                    ...
                    <div className="mt-2 pt-2 border-t border-gray-700 space-y-1">
                      {marker.skor_gizi !== undefined && (
                        <div className="flex justify-between text-sm">
                          <span className="text-gray-400">Gizi:</span>
                          <span className="font-medium text-[#22d3ee]">{Number(marker.skor_gizi).toFixed(1)}</span>
                        </div>
                      )}
              ...
              <div className="p-3 sm:p-4">
                <ResponsiveContainer width="100%" height={250}>
                  <BarChart data={chartData.data} margin={{ top: 5, right: 10, left: -10, bottom: 20 }}>
                    ...
                    />
                    <Bar dataKey="fasilitas" fill="#10b981" name="Skor Fasilitas" radius={[4, 4, 0, 0]} />
                  </BarChart>
                </ResponsiveContainer>
              </div>
            </div>
              ...
              <div className="p-3 sm:p-4">
                <ResponsiveContainer width="100%" height={250}>
                  <LineChart data={chartData.data} margin={{ top: 5, right: 10, left: -10, bottom: 20 }}>
                    ...
                    />
                    <Line type="monotone" dataKey="tenaga" stroke="#7dd3fc" strokeWidth={3} name="Skor Tenaga" dot={{ r: 3 }} />
                  </LineChart>
                </ResponsiveContainer>
              </div>
            </div>
              ...
              <div className="p-3 sm:p-4">
                <ResponsiveContainer width="100%" height={250}>
                  <BarChart data={skorComponentChartData} margin={{ top: 5, right: 10, left: -10, bottom: 20 }}>
                    <CartesianGrid strokeDasharray="3 3" stroke="rgba(34, 211, 238, 0.1)" />
                    <XAxis dataKey="name" stroke="#ffff" fontSize={10} />
                    <YAxis stroke="#ffff" fontSize={10} />
                    <Tooltip 
                      contentStyle={{ 
                        backgroundColor: 'white', 
              ...
              <div className="p-3 sm:p-4">
                <ResponsiveContainer width="100%" height={250}>
                  <BarChart data={infraChartData} margin={{ top: 5, right: 10, left: -10, bottom: 20 }}>
                    ...
                    />
                    <Bar dataKey="avg" fill="#10b981" name="Per 1000 Penduduk" radius={[4, 4, 0, 0]} />
                  </BarChart>
                </ResponsiveContainer>
              </div>
            </div>
